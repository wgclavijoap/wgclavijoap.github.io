    ...
    if ($_GET) {
        ...
        if ($action == 'add-session') {
            ...
            <div id="popup1" class="overlay">
                ...
                . '</td>
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="docid" class="form-label">Selecciona Profesional: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <select name="docid" id="" class="box" >
                                    <option value="" disabled selected hidden>Escoger Profesional de la Lista</option><br/>';
            ...
            echo     '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="nop" class="form-label">Número de empleados/Número de Citas: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
