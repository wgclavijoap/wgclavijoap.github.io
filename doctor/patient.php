            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="" method="post" class="header-search">
                        ...
                        <input type="search" name="search12" class="input-text header-searchbar" placeholder="Búsqueda Nombre de empleado o Email" list="patient">&nbsp;&nbsp;
                            ...
                            <form action="" method="post">
                                ...
                                <td width="30%">
                                    <select name="showonly" id="" class="box filter-container-items" style="width:90% ;height: 37px;margin: 0;">
                                        ...
                                        <option value="my">Solo mis empleados</option><br />
                                        <option value="all">Todos los empleados</option><br />
