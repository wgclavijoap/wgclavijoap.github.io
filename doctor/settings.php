            ...
            if ($error_1 != '4') {
                echo '
                    ...
                    . '</td>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Editar Información del profesional</p>
                                        Documento del profesional : ' . $id . ' (Auto Generado)<br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
