            ...
            <tr>
                ...
                <td>
                    <form action="schedule.php" method="post" class="header-search">
                        ...
                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Búsqueda Profesional, Nombre, Correo, Fecha (YYYY-MM-DD)" list="doctors">&nbsp;&nbsp;
                                            ...
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;line-height:30px">
                                                            Nombre del profesional:  &nbsp;&nbsp;<b>' . $docname . '</b><br>
                                                            Correo del profesional:  &nbsp;&nbsp;<b>' . $docemail . '</b> 
                                                        </div>
