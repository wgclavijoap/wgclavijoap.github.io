            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="" method="post" class="header-search">
                        ...
                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Buscar nombre del profesional o correo electrónico" list="doctors">&nbsp;&nbsp;
    ...
    if ($_GET) {
        ...
        if ($action == 'drop') {
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <h2>¿Redireccionar a las Citas de este profesional?</h2>
                        <a class="close" href="doctors.php">&times;</a>
                        <div class="content">
        ...
        if ($error_1 != '4') {
            echo '
                ...
                . '</td>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="name" class="input-text" placeholder="Nombre del profesional" value="' . $name . '" required><br>
                                        </td>
