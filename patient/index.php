        ...
        <tr class="menu-row">
            <td class="menu-btn menu-icon-doctor">
                <a href="doctors.php" class="non-style-link-menu">
                    <div>
                        <p class="menu-text">Todos los Profesionales</p>
                </a>
    </div>
    </td>
    </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p>¿No sabes como hacer el proceso? Puedes saltar directamente a la sección de
                                        <a href="doctors.php" class="non-style-link"><b>"Todos los Profesionales"</b></a> o verificar la sección de tus
                                        <a href="schedule.php" class="non-style-link"><b>"Citas"</b> </a><br>
                                        Puedes hacer un seguimiento de tu historial de citas pasadas y futuras. Infórmate también de la hora prevista de llegada del profesional.<br><br>
                                    </p>

                                    <h3>Puedes buscar tu profesional aquí</h3>
                                    <form action="schedule.php" method="post" style="display: flex">

                                        <input type="search" name="search" class="input-text " placeholder="Busca tu profesional aquí" list="doctors" style="width:45%;">&nbsp;&nbsp;
                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows == 0) {
                                        echo '<tr>
                                                    ...
                                                    <a class="non-style-link" href="schedule.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Profesional &nbsp;</font></button>
                                                    </a>
                                                    </center>
                                                    <br><br><br><br>
                                                    </td>
