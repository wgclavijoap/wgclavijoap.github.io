                            ...
                            <tr>
                                ...
                                <td width="30%">
                                    <select name="docid" id="" class="box filter-container-items" style="width:90% ;height: 37px;margin: 0;">
                                        <option value="" disabled selected hidden>Escoge Nombre Profesional de la lista</option><br />
                        ...
                        <div class="abc scroll">
                            <table width="93%" class="sub-table scrolldown" border="0">
                                ...
                                <tbody>
                                    ...
                                    <br>
                                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Ingrese un elemento de busqueda !</p>
    ...
    if ($_GET) {
        ...
        if ($action == 'add-session') {
            ...
            <div id="popup1" class="overlay">
                ...
                . '</td>
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="docid" class="form-label">Seleccional profesional: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <select name="docid" id="" class="box" >
                                    <option value="" disabled selected hidden>Escoge Nombre del profesional de la lista</option><br/>';
            ...
            echo     '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="nop" class="form-label">Número de empleados/Números de Citas: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
