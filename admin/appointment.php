            ...
            <div id="popup1" class="overlay">
                ...
                . '</td>
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="docid" class="form-label">Selecciona el profesional: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <select name="docid" id="" class="box" >
                                    <option value="" disabled selected hidden>Escoge Nombre del profesional from the list</option><br/>';
