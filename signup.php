    ...
    <center>
        <div class="container">
            <table border="0">
                <tr>
                    <td colspan="2">
                        <p class="header-text">Registro nuevo</p>
                        <p class="sub-text">Ingrese sus datos a continuación:</p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2">
                        <br>
                        <label for="" class="sub-text" style="font-weight: 280;">Si ya tiene una cuenta&#63; </label>
